<template>
  ...
  const clases = ref<
    { id?: string; nombre: string; tematica: string; driveLinkClase?: string; pdfClase?: string; youtubeVideoUrl?: string;  imagenes: { titulo: string; url: string }[]; texto?: string;  index: number; }[]
  >([]);

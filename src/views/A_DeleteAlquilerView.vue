        ...
        <div v-for="propiedad in propiedades" :key="propiedad.id">
          <div class="property-item" @click="selectProperty(propiedad.id)">
            ...
            <div class="property-details">
              ...
              <span><strong>Precio:</strong> {{ formatPrice(propiedad.precioAlquiler, propiedad.moneda) }}</span>
          ...
          <div v-if="selectedPropertyId === propiedad.id" class="property-actions">
            ...
            <div class="property-full-details">
              ...
              <p><strong>Precio Alquiler:</strong> {{ formatPrice(propiedad.precioAlquiler, propiedad.moneda) }}</p>
      ...
      <div v-if="showModal" class="modal-overlay">
        <div class="modal-content">
          ...
          <div class="property-to-delete">
            ...
            <p>Precio: {{ formatPrice(propiedadSeleccionada?.precioAlquiler, propiedadSeleccionada?.moneda) }}</p>
...
const loadProperties = async () => {
  try {
    ...
    propiedades.value = (response.data || []).map(prop => ({
      ...
      precioAlquiler: prop.precioAlquiler,
...
const deleteProperty = async () => {
  try {
    ...
    await client.models.PropiedadAlquiler.delete({ id: selectedPropertyId.value });
